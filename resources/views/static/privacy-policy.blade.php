...
<article data-cs-00002>
    <div class="limiter">
        ...
        This privacy policy is currently only available in german.<br>
        Please contact us at <a href="mailto:maurice.freuwoert@live.de?subject=Privacy%20Policy">maurice.freuwoert@live.de</a> for an english translation.
        <br><br>

        <h2>1) Information über die Erhebung personenbezogener Daten und Kontaktdaten des Verantwortlichen</h2>

        <p><b>1.1</b>&thinsp;Wir freuen uns, dass Sie unsere Website besuchen und bedanken uns für Ihr Interesse. Im Folgenden informieren wir Sie über den Umgang mit Ihren personenbezogenen Daten bei der Nutzung unserer Website. Personenbezogene Daten sind hierbei alle Daten, mit denen Sie persönlich identifiziert werden können.</p>

        <p><b>1.2</b>&thinsp;Verantwortlicher für die Datenverarbeitung auf dieser Website im Sinne der Datenschutz-Grundverordnung (DSGVO) ist Maurice Freuwört, Hinter den Gärten 1, 38729 Wallmoden, Deutschland, Tel.: 017624348630, E-Mail: maurice.freuwoert@live.de. Der für die Verarbeitung von personenbezogenen Daten Verantwortliche ist diejenige natürliche oder juristische Person, die allein oder gemeinsam mit anderen über die Zwecke und Mittel der Verarbeitung von personenbezogenen Daten entscheidet.</p>

        <p><b>1.3</b>&thinsp;Diese Website nutzt aus Sicherheitsgründen und zum Schutz der Übertragung personenbezogener Daten und anderer vertraulicher Inhalte (z.B. Bestellungen oder Anfragen an den Verantwortlichen) eine SSL-bzw. TLS-Verschlüsselung. Sie können eine verschlüsselte Verbindung an der Zeichenfolge „https://“ und dem Schloss-Symbol in Ihrer Browserzeile erkennen.</p>
        ...
        <p><b>6.1</b>&thinsp;- Übermittlung von Bilddateien zur Bestellabwicklung per Upload-Funktion<br>
        Auf unserer Website bieten wir Kunden die Möglichkeit, durch die Übermittlung von Bilddateien über eine Upload-Funktion die Personalisierung von Produkten zu beauftragen. Dabei wird das eingereichte Bildmotiv als Vorlage für die Personalisierung des gewählten Produktes verwendet.<br>
        ...
        <p><b>6.3</b>&thinsp;Verwendung von Paymentdienstleistern (Zahlungsdiensten)</p>
        ...
        Weitere Hinweise zu Google (Universal) Analytics finden Sie hier: https://policies.google.com/privacy?hl=de&amp;gl=de</p>

        <h2>8) Tools und Sonstiges</h2>

        <p>- Adobe Fonts (Typekit)<br>
        ...
        <p><b>9.1</b>&thinsp;Das geltende Datenschutzrecht gewährt Ihnen gegenüber dem Verantwortlichen hinsichtlich der Verarbeitung Ihrer personenbezogenen Daten umfassende Betroffenenrechte (Auskunfts- und Interventionsrechte), über die wir Sie nachstehend informieren:</p>
